...
class TriggerCrmApi(http.Controller):
    ...
    #  Leads
    # ------------------------------------------------------------------ #
    @http.route("/api/leads", type="http", auth="user", methods=["GET"], csrf=False)
    ...
    @http.route("/api/leads/<int:lead_id>", type="http", auth="user", methods=["GET"], csrf=False)
    ...
    @http.route("/api/projects/<int:project_id>", type="http", auth="user", methods=["GET"], csrf=False)
    ...
    # ------------------------------------------------------------------ #
    @http.route("/api/units", type="http", auth="user", methods=["GET"], csrf=False)
    ...
    @http.route("/api/activities", type="http", auth="user", methods=["POST"], csrf=False)
    ...
    @http.route("/api/activities/<int:activity_id>/done", type="http", auth="user", methods=["POST"], csrf=False)
